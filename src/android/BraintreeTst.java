package cordova.plugin.braintree.tst;
 ...
 */
public class BraintreeTst extends CordovaPlugin implements PaymentMethodNonceCreatedListener, BraintreeErrorListener {

    private static final String TAG = "BraintreeTst";
        ...
        public synchronized boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
            ...
            try {
                ...
                callbackContext.error("BraintreeTst uncaught exception: " + exception.getMessage());
            }
        ...
        public void onError(Exception error) {
            ...
            _callbackContext.error("BraintreeTst uncaught exception: " + error.getMessage());
        }
